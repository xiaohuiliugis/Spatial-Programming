...
##arcpy.env.workspace = r"C:\Xiaohui\Spatial Programming\w6\labData.gdb"
##workingDir = r"C:\Xiaohui\Spatial Programming\w6\Assign\\"

##GIS data inputs
taZones = arcpy.GetParameterAsText(0) #"taZones"
taZonesField = arcpy.GetParameterAsText(1) #"TAZ"
...
##outputs
outTaz=arcpy.GetParameterAsText(11)# "outTaz"
